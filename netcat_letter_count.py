...
if __name__ == "__main__":
    ...
    # Set the app name when creatting a Spark session
    ...
    # Create DataFrame representing the stream of input data from
    ...
    # Explode turns each item in an array into a sepatate row
    # Alias sets the name of the column for the alphabets
    # The result - each word of input is a row in a table with one\
    # column name "spark_letters"
